...
BTW, here the caller decides about constness for what he provides - not
the callee.
...
But for this the caller still can decide for the function call
...
See [SSDM: smart stack data management for software managed multicores
