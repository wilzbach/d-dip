...
1.  The first level classes distinguish between programming/logic errors
    ([/\#Error](#Error), normal run-time errors
    ([/\#Exception](#Exception) and the special out-of-memory
    situation ([/\#OutOfMemory](#OutOfMemory).
...
**See also:** [/\#IOException](#IOException
...
**See also:** [/\#FilesystemException](#FilesystemException,
...
**See also:** [/\#EncodingException](#EncodingException
